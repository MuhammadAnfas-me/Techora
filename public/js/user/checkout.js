...
// 🔹 Live Error Clearing
// =========================
document.querySelectorAll("#addAddressForm input, #addAddressForm select")
.forEach(input => {
...
async function editAddress(id) {
    try {
        ...
        const labelRadio = document.querySelector(`input[name="addLabel"][value="${data.type}"]`);
        ...
        document.querySelector('.add-address-modal-title').textContent = "Edit Address";
...
async function openCouponModal() {
     ...
     container.innerHTML += `
       <div class="coupon-item">
         ...
         <button class="select-btn" onclick="selectCoupon('${coupon.couponCode}')">
           Apply
         </button>
       </div>
     `;
